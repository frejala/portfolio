  ...
  return (
    <section className="py-4 my-20" id="road-path">
      <div className="flex flex-wrap">
        ...
        >
          <h1 className="pb-16 text-[56px] font-extrabold tracking-tight lg:text-8xl text-transparent text-stroke-white mt-16 lg:mt-0 text-center lg:text-start font-poppins">
            Road-Path
